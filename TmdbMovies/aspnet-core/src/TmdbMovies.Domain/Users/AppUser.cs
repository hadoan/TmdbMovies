...
namespace TmdbMovies.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update TmdbMoviesDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update TmdbMoviesEfCoreEntityExtensionMappings to extend the IdentityUser entity
